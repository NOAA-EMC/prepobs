...
if [[ "$netwk" = "gdas" ]];then
 ...
 case $typef in
  ...
  biascr_pc) geslist='
   ...
   ;;
  biascr_air) geslist='
   $COMINgdas/analysis/atmos/gdas.t${cyc}z.abias_air.txt'
   ;;
  radstat) geslist='
  ...
  pgbges) geslist='
   ...
   ;;
  pg2ges) geslist='
   $COMINgdas/producst/atmos/gdas.t${cyc}z.pres_a.0p25.f$gh.grib2'
   ;;
  pgbgm6) geslist='
...
# CFS-CDAS # IG Are there changes here ???? impacted by GFSv17 ???
...
# GFS
 ...
 case $typef in
  ...
  pgbcur) geslist='
   ...
   ;;
  pg2cur) geslist='
   $COMINgfs/products/atmos/gfs.t${cyc}z.pres_a.0p25.f$gh.grib2'
   fhbeg=00
   ;;
  prepqc) geslist='
  ...
  snogrb) geslist='
   ...
   ;;
  snogrb_1534) geslist='
   $COMINgfs/obs/gfs.t${cyc}z.snogrb_t1534.3072.1536'
   fhbeg=00
   fhinc=06
   ;;
  sstgrb) geslist='
...
# CDAS ## WIll there be changes here??? IG
...
# Any resolution production
 ...
 case $typef in
  ...
  pg2gp3) geslist='
   ...
   $COMINgdas/gdas.t${cyc}z.pres_a.0p25.f$ghp3i.grib2
