...
################################################################################
#
#  corecount_combine.sh, merges 4 html files into a single file.
...
# We have option here to rebuild the core counts main page starting with 
# content from $FIXprepobs/corecounts_base.shtml.  Before doing so,
