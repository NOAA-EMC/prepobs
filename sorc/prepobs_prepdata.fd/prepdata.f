...
C         DAT(NL,12) = NINT(RDATA(II+11))
C         IS(NL,1) = NINT(RDATA(II+11))
C         DAT(NL,13) = (NINT(RDATA(II+12))/100000.)
C         IS(NL,2) = (NINT(RDATA(II+12))/100000.)
C         DAT(NL,14) = (NINT(RDATA(II+13))/100000.)
C         IS(NL,3) = (NINT(RDATA(II+13))/100000.)
         PRINT *, "NICKE ADPUPA1:",RDATA(II+1),RDATA(II+2),RDATA(II+3)
C         PRINT *, "NICKE ADPUPA2:",RDATA(II+4),RDATA(II+5),RDATA(II+6)
C         PRINT *, "NICKE ADPUPA3:",RDATA(II+7),RDATA(II+8),RDATA(II+9)
         PRINT *, "NICKE ADPUPA4:",IPM,IZM,ITM,IQM,IVM
C         PRINT *, "NICKE ADPUPA5:",RDATA(II+10),RDATA(II+11)
         PRINT *, "NICKE ADPUPA5:",RDATA(II+10),RDATA(II+11)
C         PRINT *, "NICKE ADPUPA6:",RDATA(II+12),RDATA(II+13)
C         PRINT *, "NICKE ADPUPA7:",RDATA(II+14),RDATA(II+15)
C         PRINT *, "NICKE ADPUPA8:",RDATA(II+16),RDATA(II+17)
C         PRINT *, "NICKE ADPUPA9:",RDATA(II+18),RDATA(II+19)
C         PRINT *, "NICKE ADPUPA10:",RDATA(II+20),RDATA(II+21)
C         PRINT *, "NICKE ADPUPA11:",RDATA(II+22),RDATA(II+23)
C         PRINT *, "NICKE ADPUPA12:",RDATA(II+24),RDATA(II+25)
         IBTEST = 0
...
C PROCESS NON-MSG WIND REGARDLESS OF PREPBUFR TABLE VALUE
            ...
            IQ(NL,4) = IVM
         END IF
         PRINT *, "NICKE111", RDATA(II+11),RDATA(II+12),RDATA(II+13)
C            DAT(NL,12) = NINT(RDATA(II+11))
C            IS(NL,1) = NINT(RDATA(II+11))
C            DAT(NL,13) = (NINT(RDATA(II+12))/100000.)
C            IS(NL,2) = (NINT(RDATA(II+12))/100000.)
...
C      PRINT *, "NICKE IDATA"
C      DO QQQ = 1,100
C         PRINT *, "QQQ: ", QQQ, IDATA(QQQ), RDATA(QQQ)
C      ENDDO
      NB = 0
      NN = IDATA(31)
C      II = IDATA(32) - 11
...
C x   NN = MIN(NN,LEVPM)
      ...
      DO N = 1,NN
C         PRINT *, "NICKE PRE", RDATA(II+12),RDATA(II+13),RDATA(II+14)
C         II = II + 11
         II = II + 14
C GET PREPBUFR TABLE VALUES FOR PRESSURE, HGHT, TEMP., MOISTURE, & WIND
         IPM = NINT(RDATA(II+ 6))
         ...
         IQM = NINT(RDATA(II+ 9))
         IVM = NINT(RDATA(II+10))
         DAT(NL,12) = RDATA(II+11)
         IS(NL,1) = RDATA(II+11)
         DAT(NL,13) = (NINT(RDATA(II+12))*0.00001)
         IS(NL,2) = (NINT(RDATA(II+12))*0.00001)
         DAT(NL,14) = (NINT(RDATA(II+13))*0.00001)
...
C PROCESS NON-MSG WIND REGARDLESS OF PREPBUFR TABLE VALUE
            ...
            IQ(NL,4) = IVM
         END IF
C            DAT(NL,12) = RDATA(II+11)
C            IS(NL,1) = RDATA(II+11)
C            DAT(NL,13) = (NINT(RDATA(II+12))*0.00001)
C            IS(NL,2) = (NINT(RDATA(II+12))*0.00001)
C            DAT(NL,14) = (NINT(RDATA(II+13))*0.00001)
...
C         PRINT *, "NICKE NEWRDATA2a", DAT(NL,4),DAT(NL,5),DAT(NL,6)
C         PRINT *, "NICKENEWRDATA",RDATA(II+3),RDATA(II+4),RDATA(II+5)
C         PRINT *, "NICKE NEWRDATA3a", DAT(NL,7),DAT(NL,8),DAT(NL,9)
C         PRINT *, "NICKENEWRDATA",RDATA(II+6),RDATA(II+7),RDATA(II+8) 
C         PRINT *, "NICKE NEWRDATA4a", DAT(NL,10),DAT(NL,11),DAT(NL,12)
C         PRINT *, "NICKENEWRDATA",RDATA(II+9),RDATA(II+10),RDATA(II+11)
C         PRINT *, "NICKE NEWRDATA5a", DAT(NL,13),DAT(NL,14),DAT(NL,15)
C         PRINT *, "NICKENEWRDATA",RDATA(II+12),RDATA(II+13),RDATA(II+14)
C         PRINT *, "NICKE NEWRDATA6a", DAT(NL,16),DAT(NL,17),DAT(NL,18)
C         PRINT *, "NICKENEWRDATA",RDATA(II+15),RDATA(II+16),RDATA(II+17)
C         PRINT *, "NICKE NEWRDATA7a", DAT(NL,19),DAT(NL,20),DAT(NL,21)
C         PRINT *, "NICKENEWRDATA",RDATA(II+18),RDATA(II+19),RDATA(II+20)
         PRINT *, "NICKE 345:",RDATA(II+11),RDATA(II+12),RDATA(II+13)
...
C      PARAMETER (NUMDAT = NUMVAR + (2 * NUMQMS))
     ...
     $ JR(MXLVL,NUMQMS),TEST(MXLVL,NUMQMS)
  ...
  902 FORMAT(/' SMERGE: ',A8,', CAT. 1,2,5,10 LVLS PRIOR TO DUPL. CHK')
         IF(KLVL.GT.0)  THEN
            DO N = 1,KLVL
               ...
               PRINT 905, (IQ(N,L),L=1,NUMQMS)
               PRINT 910, (IS(N,QQ),QQ=1,NUMGPS)
               PRINT 915, (TEST(N,NEW),NEW=1,NUMQMS)
            ENDDO
         END IF
         PRINT 901
      END IF
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  905 FORMAT('+',102X,8I3)
  910 FORMAT('+',F13.5,F13.5,F13.5)
  915 FORMAT('+',F13.5,F13.5,F13.5,F13.5,F13.5)
  901 FORMAT('0',//)
...
C  CATEGORY. FOR ALL RPTS
 ...
 1902 FORMAT(//,15X,'>>> COMPLETE LISTING OF DATA FOR STATION ID ',A8,
  ...
  899 FORMAT(2X,'     UPPER-',4X,'PRESSURE',6X,'HEIGHT',4X,
     ...
     $ ,8X,'(M/S)',4X,'TV/RC',4X,'TV/RC',4X,'TV/RC',4X,'  TV/RC'/)
         PRINT 7901, (IQ(N,3),(DAT(N,K),K=1,6),IQ(N,1),IR(N,1),IQ(N,2),
     $    IR(N,2),IQ(N,4),IR(N,4),IQ(N,5),IR(N,5),IS(N,1),IS(N+1,1),
     $    IS(N,2),IS(N+1,2),IS(N,3),IS(N+1,3),N=1,NSTA)
 7901    FORMAT(6X,I2,F16.2,F14.2,F12.2,F13.2,F11.2,F13.2,I6,'/',I3,
     $    I5,'/',I3,I5,'/',I3,I7,'/',I3,F13.5,F13.5,F13.5,F13.5,
     $    F13.5,F13.5)
         PRINT 7902
      END IF
 7902 FORMAT(//)
