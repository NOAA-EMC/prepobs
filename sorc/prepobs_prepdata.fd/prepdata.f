...
C              HUNDREDTHS OF AN HR) - (MAX IS +/- 12 HRS) (DEFAULT=300.)
CC
C  N O T E -- THE FOLLOWING (2,10) ARRAY REFERS TO THE 2 GEOGRAPHICAL
C              REGIONS & THE 10 AIRCRAFT FLIGHT LVL REPORT TYPES POSSIBLE
...
C                    10 - AMDAR over AFIRS 
CC
C    AWINDO - TIME WINDOW (+/-) FOR ACFT RPTS (IN HUNDREDTHS OF AN HR)
C             - (MAX IS +/- 12 HRS)
C                         (DEFAULT - AWINDO(2,10)/6*325.,2*325.,12*325./)
CC
...
C               (DEFAULT - IACFTH(10)/3*18000,16500,4*18000,16500,18000)
...
C  IN INTERFACE WITH SUBROUTINE IW3UNPBF
     ...
     $ KSKSWD(10),RFFL,QIFY,QIFN,EEQF
      COMMON/ACFTSW/AWINDO(2,10),AIRLND(6,10),JAWIND(6,10),JAMASS(6,10),
     $ IACFTL(10),IACFTH(10),PHIACF(7),KEPAC(6,10),AIFNOW(10),POAF,
     $ TRBX(5),FLACMS(10),PCAT,ROLF,aMSTQ,RIALR
     ...
     $ KSKSWN,KSKACF,KNDCDE(3),KSKCLS,KSKTHN,KSKOMR(2),KSKALM(10),
     $ KSKAHM(10),KSKNOW(10),KSKDRP
...
C  THAT LAST INCOMPLETE BUFR MESSAGE SHOULD BE WRITTEN OUT
 ...
 1951 FORMAT(/,35X,
     ...
     $ '   -- NUMBER OF CLASS SOUNDINGS                  = ',I8)
      PRINT 1958, KSKSWN,KSKACF,(IACFTL(II),KSKALM(II),II=1,10),
     $ (IACFTH(II),KSKAHM(II),II=1,10),(KSKNOW(II),II=1,10)
 1958 FORMAT(35X,
     ...
     $ '   -- NO. OF AFAMDAR ACF RPTS BELOW',I6,' METERS = ',I8,/,35X,
     ...
     $ '   -- NO. OF AFAMDAR ACF RPTS ABOVE',I6,' METERS = ',I8,/,35X,
     ...
     $ '   -- NO. AFAMDAR ACFT RPTS W/MSG WND & VALID MASS= ',I8,/,35X,
...
C  LEVELS THAT CAN BE PROCESSED AND ENCODED INTO BUFR MESSAGES
     ...
     $ KSKALM(10),KSKAHM(10),KSKNOW(10),KSKDRP
      COMMON/MISWCH/XWINDO(6,4),JPSSMI(6,4),SRAD(7),KNTSMI(4),KTIMM(4),
     $ KSKPMI,KMSGMI,KBDYMI
      COMMON/SCTWCH/IEWNDO(2),JPERSD(6),IQWNDO(2),JPQKSD(6),IWWNDO(2),
     $ JPWDSD(6),KSKPSC(4),KMSGSC(4),KBDYSC(4),KTIMSC(4),KNTSCT(4),
...
C CHECK TO SEE IF AIRCFT DATA SHOULD BE PROCESSED
     ...
     $      SUBSKP(004,013).AND.SUBSKP(004,017).AND.SUBSKP(004,103))
     $    GO TO 7001
  ...
  876          FORMAT(27X,A56,F5.0)
     ...
     $            .NOT.SUBSKP(004,013))  THEN
      ...
      NAME2 = 'TAMDARB AIRCFT;   IN  US MNLND/G.MEX/S.ONT.-MINUS & PLUS'
               ...
               END IF
               IF(.NOT.SUBSKP(004,017))  THEN
      NAME2 = 'AFAMDAR AIRCFT;   OUT US MNLND/G.MEX/S.ONT.-MINUS & PLUS'
                  PRINT 873, NAME2,AWINDO(1,10)
      NAME2 = 'AFAMDAR AIRCFT;   IN  US MNLND/G.MEX/S.ONT.-MINUS & PLUS'
                  PRINT 873, NAME2,AWINDO(2,10)
               END IF
               PRINT'(1X)'
...
C  TAMDAR(M/B), CAMDAR, KAMDAR, AMDARB, AFAMDAR) RPTS (R. TYPE 41)
C***********************************************************************
C-----------------------------------------------------------------------
...
C    =6-CAMDAR; =7-KAMDAR; =8-AMDARB; =9-TAMDARB; =10-AFAMDAR}
C-----------------------------------------------------------------------
...
C$$$
     ...
     $ KSKCLS,KSKTHN,KSKOMR(2),KSKALM(10),KSKAHM(10),KSKNOW(10),KSKDRP
      COMMON/SFCBFR/ALTIMR,PRSS
      COMMON/SKPSUB/SUBSKP(0:255,0:200)
      COMMON/DIRECT/OBS3(5,MXBLVL,7),OBS2(NUMOBS2),NOBS3(7),RDATA2(25),
     $ obs8_8(2)
...
C$$$
     ...
     $ SWNLND/480*.TRUE./,AIRLND/60*.TRUE./,PG4243/.TRUE./,
     ...
     $ TOVRTV/.FALSE./,AIFNOW/10*.TRUE./,FLDMGS/.TRUE./,
     $ FLACMS/10*.TRUE./,GOESRD/2*.FALSE./,PREVEN/.FALSE./,
     ...
     $ AWINDO/6*325.,2*325.,12*325./,SWINDO_e/12*-300.,6*-700.,
     ...
     $ ISATOB/0/,IPRINT/0/,ISATLS/80*2/
      DATA  JAWIND/60*0/,JAMASS/60*0/,JSURFM/13*0/,
     ...
     $      IACFTL/100,9*-200/,IACFTH/3*18000,16500,4*18000,16500,18000/,
     $      LSMASS/9999/,LSWIND/9999/,KEPAC/60*0/,IGCHN/18*IMISS/,
     ...
     $      KIPTTV/2*0/,KSKTHN/0/,KJFLAG/2*0/,KSKOMR/2*0/,KSKALM/10*0/,
     ...
     $      KNTSCT/4*0/,KSKNOW/10*0/,KSKSWD/10*0/,KSEATV/2*0/,KNTGIC/0/,
     $      KSEAGI/3*0/,KSKDRP/0/,KNOCTP/0/,KSKAHM/10*0/,KNTGPS/0/,
